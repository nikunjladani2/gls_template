...
class Template44Screen extends StatelessWidget {
  const Template44Screen({Key? key}) : super(key: key);
...
class _Template44Body extends StatefulWidget {
  @override
  _Template44BodyState createState() => _Template44BodyState();
}

class _Template44BodyState extends State<_Template44Body> {
  HeaderVO? _headerVO;
    ...
    return TGView.columnContainer(
        ...
        children: [
          Row(
            ...
            children: [
              Image.file(File(_headerVO!.logoUrl!), height: 80, width: 80, fit: BoxFit.cover),
          ...
          textLabel(text: _headerVO!.website!, color: _headerVO!.textColor!, size: fontSize15),
          textLabel(text: "Offer Expires ${_headerVO!.expiryDate!}", color: _headerVO!.textColor!, size: fontSize15),
        ]);
  }
  ...
  Widget _addressContainer() {
    return TGView.columnContainer(mainAxisAlignment: MainAxisAlignment.center, children: [
      textLabel(
          text: _headerVO!.storeAddress!, color: _headerVO!.textColor!, fontWeight: FontWeight.bold, size: fontSize20),
      textLabel(
          ...
          size: fontSize20),
      TGView.emptySizedBox(height: 5),
      textLabel(text: _headerVO!.phoneNo!, color: _headerVO!.textColor!, fontWeight: FontWeight.bold, size: fontSize25),
    ]);
  }
          ...
          child: SizedBox(
            ...
            child: TGView.columnContainer(
                ...
                children: [
                  SizedBox(
                    //height: 30,
                    child: textLabel(text: itemVO.name, maxLines: 2, size: fontSize15, fontWeight: FontWeight.w500),
                  ),
                  // TGView.emptySizedBox(height: 18),
                  const Spacer(),
                  textLabel(text: itemVO.quantity, size: fontSize15, fontWeight: FontWeight.bold),
                  TGView.emptySizedBox(height: 5),
                  Container(
  ...
  _onErrorProductDetail(TGResponse errorResponse, {required BuildContext context}) async {
    TGLog.d("ProductDetailResponse : onError() > " + errorResponse.body.toString());
